...
#include "cl_sparse_apis.h"
#define CL_OBJ_MAP(fnc)        (GLOBALS(cl)->fnc)
#define CL_OBJ_CL     GLOBALS(cl)
#define EMIT  CL_OBJ  /* easier-to-read alias */
...
void
proceed(struct symbol_list *filelist, struct symbol_list *symlist)
{
    char *file;
